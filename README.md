...
[![npm](https://img.shields.io/npm/v/peasy-dev-embed)](https://www.npmjs.com/package/peasy-dev-embed)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
[![Zero Dependencies](https://img.shields.io/badge/dependencies-0-brightgreen)](https://www.npmjs.com/package/peasy-dev-embed)
[![Size](https://img.shields.io/badge/gzipped-<8KB-green)](https://bundlephobia.com/package/peasy-dev-embed)
...
PeasyDev is part of the [Peasy Tools](https://peasytools.com) ecosystem, providing 11 widget types for embedding file format information, tool cards, conversion guides, glossary terms, search boxes, and interactive tools directly into your pages.

> **Try the interactive widget builder at [widget.peasydev.com](https://widget.peasydev.com)** -- build, preview, and copy embed code for any widget type.

<p align="center">
  <img src="demo.gif" alt="peasy-dev-embed demo -- embed peasydev widgets with Shadow DOM isolation and theme support" width="800">
</p>
...
> **Note:** The `data-slug` value uses the format `category-slug/tool-slug`. Find available tools at [peasydev.com/api/v1/tools/](https://peasydev.com/api/v1/tools/).
...
Visit [peasydev.com](https://peasydev.com) for the full PeasyDev experience.

- **All Tools**: [peasydev.com](https://peasydev.com)
- **Formats**: [peasydev.com/formats/](https://peasydev.com/formats/)
- **Glossary**: [peasydev.com/glossary/](https://peasydev.com/glossary/)
- **Guides**: [peasydev.com/guides/](https://peasydev.com/guides/)
- **API Documentation**: [peasydev.com/developers/](https://peasydev.com/developers/)
- **OpenAPI Spec**: [peasydev.com/api/openapi.json](https://peasydev.com/api/openapi.json)
- **Widget Builder**: [widget.peasydev.com](https://widget.peasydev.com)
- **npm Package**: [npmjs.com/package/peasy-dev-embed](https://www.npmjs.com/package/peasy-dev-embed)
...
Embed [PeasyDev](https://peasydev.com) widgets on any website with [peasy-dev-embed](https://widget.peasydev.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-dev-embed@1/dist/embed.min.js"></script>
<div data-peasydev="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasydev.com)
